/*from library name*/
import {AfterViewInit, Component, IterableDiffers, OnChanges, OnInit, ChangeDetectorRef, DoCheck, Input} from '@angular/core';
...
//   }
//    ngDoCheck(){
//     //const change = this.heatList.diff(heatList);
//     this.heatList = heatList
//     //console.log(change);
//   }
//   refreshData(){
